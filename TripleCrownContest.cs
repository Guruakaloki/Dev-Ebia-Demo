...
{
    public static class TripleCrownContest
    {
        [FunctionName("TripleCrownContest")]
        public static IActionResult Run(
            [HttpTrigger(AuthorizationLevel.Function, "get", Route = "triplecrowncontest/{id}")]
            ...
            [CosmosDB(
                ...
                PartitionKey ="/id",
                SqlQuery = "select c.tripleCrownContestDetails from TripleCrownContest c where upper(c.id)=upper({id})"
                )]
